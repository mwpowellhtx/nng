...
extern int nni_getopt_usec(const nni_duration *, void *, size_t *);
...
extern int nni_getopt_int(const int *, void *, size_t *);

// nni_getopt_u64 gets an unsigned 64 bit number.
extern int nni_getopt_u64(const uint64_t, void *, size_t *);
...
extern int nni_getopt_size(const size_t *, void *, size_t *);
